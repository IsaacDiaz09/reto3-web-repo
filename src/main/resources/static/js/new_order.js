import { mostrarMensaje, urlbase, urlUtils } from "./utils.js";
...
$(document).ready(function () {
    $.get(urlUtils + "/get_user_info", function (user) {
        $.get(urlbase + "/user/" + user.id, function (data) {
            salesMan = data;
        })
    }
    )
...
$(document).ready(function () {
    $("#save-order").click(function () {
        $.get(urlUtils + "/get_autogenerated_order_id", function (response) {
